...
window.drupalTranslations = {"strings":{"":{"Home":"Home","Next":"Volgende","closed":"gesloten","Cancel":"Annuleren","Save":"Opslaan","Open":"Open","Continue":"Doorgaan","Close":"Sluiten","Show":"Weergeven","Select all rows in this table":"Selecteer alle regels van deze tabel","Deselect all rows in this table":"De-selecteer alle regels van deze tabel","Extend":"Uitbreiding","Changed":"Gewijzigd","Please wait...":"Even geduld...","Hide":"Verbergen","Not promoted":"Niet aangeraden","Error message":"Foutmelding","Warning message":"Waarschuwingsbericht","By @name on @date":"Door @name op @date","By @name":"Door @name","Alias: @alias":"Alias: @alias","No alias":"Geen alias","@label":"@label","New revision":"Nieuwe revisie","No revision":"Geen revisie","(active tab)":"(actieve tabblad)","Status message":"Statusbericht","An AJAX HTTP error occurred.":"Er is een AJAX HTTP fout opgetreden.","HTTP Result Code: !status":"HTTP-resultaatcode: !status","An AJAX HTTP request terminated abnormally.":"Een AJAX HTTP-aanvraag is onverwacht afgebroken","Debugging information follows.":"Debug informatie volgt.","Path: !uri":"Pad: !uri","StatusText: !statusText":"Statustekst: !statusText","ResponseText: !responseText":"Antwoordtekst: !responseText","ReadyState: !readyState":"ReadyState: !readyState","Hide summary":"Samenvatting verbergen","Edit summary":"Samenvatting bewerken","Collapse":"Inklappen","The selected file %filename cannot be uploaded. Only files with the following extensions are allowed: %extensions.":"Het bestand %filename kan niet ge\u00fcpload worden. Alleen bestanden met de volgende extensies zijn toegestaan: %extensions","Needs to be updated":"Moet worden bijgewerkt","Does not need to be updated":"Hoeft niet te worden bijgewerkt","Show all columns":"Alle kolommen tonen","Show table cells that were hidden to make the table fit within a small screen.":"Toon de tabelcellen die verborgen werden om de tabel te laten passen op een klein scherm.","List additional actions":"Aanvullende acties weergeven","Flag other translations as outdated":"Markeer andere vertalingen als verouderd","Do not flag other translations as outdated":"Markeer andere vertalingen niet als verouderd","opened":"geopend","Horizontal orientation":"Horizontale ori\u00ebntatie","Vertical orientation":"Verticale ori\u00ebntatie","Tray orientation changed to @orientation.":"Ori\u00ebntatie van de lade aangepast naar @orientation.","@action @title configuration options":"@action @title configuratie-instellingen","Tabbing is no longer constrained by the Contextual module.":"Gebruik van tab-toets is niet langer beperkt tot de contextuele links.","Tabbing is constrained to a set of @contextualsCount and the edit mode toggle.":"Gebruik van de tab-toets is beperkt tot een set van @contextualsCount en het wisselen van de bewerkenmodus.","Press the esc key to exit.":"Druk op de ESC-toets om af te sluiten.","@count contextual link\u0003@count contextual links":"@count contextuele link\u0003@count contextuele links","!tour_item of !total":"!tour_item van !total","End tour":"Rondleiding be\u00ebindigen","The toolbar cannot be set to a horizontal orientation when it is locked.":"Als de werkbalk geblokkeerd is kan deze niet op horizontale ori\u00ebntatie gezet worden.","Changing the text format to %text_format will permanently remove content that is not allowed in that text format.\u003Cbr\u003E\u003Cbr\u003ESave your changes before switching the text format to avoid losing data.":"Wijzigen van de tekstopmaak naar %text_format zal inhoud die niet toegestaan is in die opmaak permanent verwijderen.\u003Cbr\u003E\u003Cbr\u003ESla uw wijzigingen op voordat u de tekstopmaak omschakelt, om gegevensverlies te voorkomen.","Change text format?":"Tekstopmaak aanpassen?","Tray \u0022@tray\u0022 @action.":"Lade \u0027@tray\u0027 @action.","Tray @action.":"Lade @action.","Hide lower priority columns":"Kolommen met een lagere prioriteit verbergen","The response failed verification so will not be processed.":"Het antwoord kon niet geverifieerd worden en zal daarom niet worden verwerkt.","The callback URL is not local and not trusted: !url":"De callback-URL is niet lokaal en vertrouwd: !url","CustomMessage: !customMessage":"CustomMessage: !customMessage","Authored on @date":"Aangemaakt op @date","Text alternative":"Alternatieve tekst","Field Not Editable":"Veld niet bewerkbaar","CKEditor 5 is not compatible with IE11.":"CKEditor 5 is niet compatibel met IE11.","A rich text editor is available for this field when used with \u003Ca href=\u0022@supported-browsers\u0022\u003Esupported browsers\u003C\/a\u003E other than Internet Explorer.":"Voor dit veld is een uitgebreide tekst-editor beschikbaar als u een \u003Ca href=\u0022@supported-browsers\u0022\u003Eondersteunde browser\u003C\/a\u003E gebruikt, maar niet voor Internet Explorer.","Decorative image":"Decoratieve afbeelding","Add missing alternative text":"Ontbrekende alternatieve tekst toevoegen","Change image alternative text":"Alternatieve tekst wijzigen","An error occurred during the execution of the Ajax response: !error":"Er is een fout opgetreden bij het uitvoeren van een Ajax-verzoek: !error","The following files could not be loaded: @dependencies":"De volgende bestanden konden niet geladen worden: @dependencies","Hide sidebar panel":"Zijbalkpaneel verbergen","Show sidebar panel":"Zijbalkpaneel tonen"}},"pluralFormula":{"1":0,"default":1}};;
/**
* DO NOT EDIT THIS FILE.
* See the following change record for more information,
* https://www.drupal.org/node/2815083
