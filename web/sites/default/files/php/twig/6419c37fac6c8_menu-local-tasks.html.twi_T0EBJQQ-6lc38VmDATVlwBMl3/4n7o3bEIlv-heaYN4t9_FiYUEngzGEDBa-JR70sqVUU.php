...
/* themes/contrib/electra/templates/menu/menu-local-tasks.html.twig */
class __TwigTemplate_132546922b81a56004e5bfde37e4e750a9ca21e1d53f24e3767423d0af97c6f1 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if (($context["primary"] ?? null)) {
            ...
            echo "</h2>
  <ul class=\"nav nav-tabs primary tab-basic\">";
            // line 16
...
";
    ...
    {
        return "themes/contrib/electra/templates/menu/menu-local-tasks.html.twig";
    }
...
{% if primary %}
  ...
  <ul class=\"nav nav-tabs primary tab-basic\">{{ primary }}</ul>
{% endif %}
{% if secondary %}
  <h2 class=\"visually-hidden\">{{ 'Secondary tabs'|t }}</h2>
  <ul class=\"nav secondary\">{{ secondary }}</ul>
{% endif %}
", "themes/contrib/electra/templates/menu/menu-local-tasks.html.twig", "/var/www/html/web/themes/contrib/electra/templates/menu/menu-local-tasks.html.twig");
    }
