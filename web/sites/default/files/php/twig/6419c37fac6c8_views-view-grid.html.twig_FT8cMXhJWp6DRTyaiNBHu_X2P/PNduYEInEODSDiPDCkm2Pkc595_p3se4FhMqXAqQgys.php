...
/* themes/contrib/electra/templates/views/views-view-grid.html.twig */
class __TwigTemplate_e79fc4ae2fdb0c9650f8d91a007d6e82accefe2a7dd448175289e9ec45a10df5 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "themes/contrib/electra/templates/views/views-view-grid.html.twig";
    }
    ...
    {% for row in items %}
      <div{{ row.attributes.addClass(row_classes, options.row_class_default ? 'row-' ~ loop.index) }}>
        {% for column in row.content %}
          <div{{ column.attributes.addClass(col_classes, options.col_class_default ? 'c-' ~ loop.index) }}>
            {{- column.content -}}
          </div>
        {% endfor %}
      </div>
...
", "themes/contrib/electra/templates/views/views-view-grid.html.twig", "/var/www/html/web/themes/contrib/electra/templates/views/views-view-grid.html.twig");
    }
