...
class __TwigTemplate_49bca5853922107202857a132c82893fc7a669980ff7f3d99f1d05365f52e317 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% if content %}
  <section {{ attributes }} {{ attributes.addClass(classes) }}>
    <div class=\"container\">
      <div class=\"banner-content page-header-content\">
        {{ content }}
      </div>
...
{% endif %}
", "themes/contrib/electra/templates/region/region--content-header.html.twig", "/var/www/html/web/themes/contrib/electra/templates/region/region--content-header.html.twig");
    }
