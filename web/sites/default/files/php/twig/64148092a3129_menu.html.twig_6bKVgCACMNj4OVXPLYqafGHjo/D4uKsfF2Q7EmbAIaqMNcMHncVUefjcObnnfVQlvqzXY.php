...
class __TwigTemplate_62f16400c5b3f1141f0b6d9d0ec4a52e431b694fccec0ecd5a6d41397e4ed24c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["menu_level"] ?? null) == 0) &&  !twig_get_attribute($this->env, $this->source, $context["item"], "is_expanded", [], "any", false, false, true, 37)) &&  !twig_get_attribute($this->env, $this->source, $context["item"], "below", [], "any", false, false, true, 37))) {
    ...
    {
        return new Source("", "themes/contrib/electra/templates/menu/menu.html.twig", "/var/www/html/web/themes/contrib/electra/templates/menu/menu.html.twig");
    }
