...
class __TwigTemplate_d9bea1f407841c1bb041f87e9f02877ed1230968231b5116c37c278e6356f852 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <ul class=\"pagination justify-content-center js-pager__items\">
      ...
      {% if items.first %}
        <li class=\"page-item page-item--first\">
          <a class=\"page-link\" href=\"{{ items.first.href }}\" title=\"{{ 'Go to first page'|t }}\" rel=\"prev\"{{ items.first.attributes }}>
      ...
      {% for key, item in items.pages %}
        <li class=\"page-item page-item{{ current == key ? ' is-active active' : '' }}\">
          {% if current == key %}
...
{% endif %}
", "themes/contrib/electra/templates/menu/pager.html.twig", "/var/www/html/web/themes/contrib/electra/templates/menu/pager.html.twig");
    }
