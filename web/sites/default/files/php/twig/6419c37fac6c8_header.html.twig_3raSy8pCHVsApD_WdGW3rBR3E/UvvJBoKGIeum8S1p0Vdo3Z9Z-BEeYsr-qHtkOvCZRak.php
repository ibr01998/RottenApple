...
class __TwigTemplate_494f2716edd801365e99fb59073bcc07f2d026d13eaab608b6974516bc270902 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{%
  set header_classes = [
    ...
    'navbar',
    'navbar-expand-lg',
    electra.header_link_style,
    'header-menu',
    electra.header_type,
    electra.header_position,
  ]
%}

<nav {{ header_attribute.addClass(header_classes) }} {{ header_attribute.setAttribute('data-fixed', electra.header_type_sticky ).setAttribute('data-resize', electra.header_type_sticky_resize ).setAttribute('data-bgcolor', electra.header_color ) }}>
  <div class=\"container\">
    {% if page.header_left %}
      {{ page.header_left }}
    {% endif %}
...
<!-- end of nav -->
", "@electra/includes/header.html.twig", "/var/www/html/web/themes/contrib/electra/templates/includes/header.html.twig");
    }
